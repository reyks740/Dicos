...
public class View extends javax.swing.JFrame {
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try {
            ...
            if("".equals(fName.getText())){
                ...
                JOptionPane.showMessageDialog(new JFrame(), "Nombre es requerido", "Dialogo",
                                     JOptionPane.ERROR_MESSAGE);
            }else if("".equals(lName.getText())){
             
                JOptionPane.showMessageDialog(new JFrame(), "Apellido es requerido", "Dialogo",
                                     JOptionPane.ERROR_MESSAGE);
            }else if("".equals(email.getText())){
             
                JOptionPane.showMessageDialog(new JFrame(), "Email es requerido", "Dialogo",
                                     JOptionPane.ERROR_MESSAGE);
            }else {
                fN = fName.getText();
                lN = lName.getText();
        ...
        try {
            ...
            if("".equals(ID)){
              JOptionPane.showMessageDialog(new JFrame(), "ID is require", "Dialog",
               ...
               if(notFound == 0){
                  JOptionPane.showMessageDialog(new JFrame(), "invalid ID", "Dialogo",
                                     JOptionPane.ERROR_MESSAGE);
               }
            }
        }catch(Exception e){
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            ...
            ID = serachData.getText();
            if("".equals(ID)){
              JOptionPane.showMessageDialog(new JFrame(), "ID es requerido", "Dialogo",
                                     JOptionPane.ERROR_MESSAGE);
            }else {
               String sql = "SELECT * FROM user WHERE id="+ID;
               ResultSet rs = st.executeQuery(sql);
               ...
               if(notFound == 0){
                  JOptionPane.showMessageDialog(new JFrame(), "ID invalido", "Dialogo",
                                     JOptionPane.ERROR_MESSAGE);
               }
            }
        }catch(Exception e){
